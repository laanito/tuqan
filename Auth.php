 ...
 * @version    CVS: $Id: TuqanAuth.php,v 1.1 2006-12-04 06:56:27 aballesteros Exp $
 ...
 * @copyright  2001-2006 The PHP Group
 * @license    http://www.php.net/license/3_01.txt  PHP License 3.01
 * @version    Release: 1.4.2  File: $Revision: 1.1 $
 * @link       http://pear.php.net/package/Auth
 */
class Auth
{
    ...
    function __construct($storageDriver, $options = '', $loginFunction = '', $showLogin = true)
    {
        ...
        if (!session_id()) {
            ...
            if (!session_id()) {
                // Throw error
                $pera=new \PEAR();
                $pera->throwError('Session could not be started by Auth, '
