...
// +----------------------------------------------------------------------+
//
// $Id: Default.php,v 1.1 2006-08-31 08:36:07 jmartinez Exp $
...
class HTML_QuickForm_Renderer_Default extends HTML_QuickForm_Renderer
{
     ...
     */
    var $_headerTemplate =
        "\n\t<tr>\n\t\t<td id=\"header\" colspan=\"2\"><b>{header}</b></td>\n\t</tr>";
    /**
    ...
    var $_elementTemplate =
        "\n\t<tr>\n\t\t<td class=\"campos\" align=\"justify\" valign=\"top\"><!-- BEGIN required --><span style=\"color: #ff0000\">*</span><!-- END required --><b>{label}</b></td>\n\t\t<td valign=\"top\" align=\"left\"><!-- BEGIN error --><span style=\"color: #ff0000\">{error}</span><br /><!-- END error -->\t{element}</td>\n\t</tr>";
     ...
     */
    var $_formTemplate =
        "\n<form{attributes}>\n<div>\n{hidden}<table class=\"quickform\" border=\"0\">\n{content}\n</table>\n</div>\n</form>";
