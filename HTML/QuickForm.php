...
// +----------------------------------------------------------------------+
//
// $Id: QuickForm.php,v 1.1 2006-08-31 08:36:07 jmartinez Exp $
...
class HTML_QuickForm extends HTML_Common
{
     ...
     * @access    private
     */
    var $_requiredNote = '<span style="font-size:80%; color:#ff0000;">*</span><span style="font-size:80%;"> Campo requerido</span>';
