...
class Procesar_Formularios
{
    ...
    function procesa_Formulario($sAccion, $aParametros = null)
    {
        if ($aParametros != null) {
            ...
            return ("diviframe|<iframe id=\"form\" src=\"/main/?action=inicio:nuevo:formulario:general&sesion=&datos=" .
        ...
        if ($aIterador = $oBaseDatos->coger_Fila()) {
            if ($aIterador[0] == true) {
                ...
                if ($aParametros != null) {
                    ...
                    return ("diviframe|<iframe id=\"form\" src=\"/main/?action=inicio:nuevo:formulario:general&sesion=&datos=" . $sAccion . separador . $iId . "\"  width=\"90%\"" .
                        " height=\"1000px\" scrolling=\"auto\" frameborder=\"0\"><\iframe>");
                } else {
                    return ("diviframe|<iframe id=\"form\" src=\"/main/?action=inicio:nuevo:formulario:general&sesion=&datos=" . $sAccion . "\" width=\"90%\" " .
                        " height=\"1000px\" scrolling=\"auto\" frameborder=\"0\"  ><\iframe>");
                }
            }
        }
    ...
    function procesa_Formulario_Informe($sAccion, $aParametros)
    {
        ...
        if ($aIterador = $oBaseDatos->coger_Fila()) {
            if ($aIterador[0] == gettext('sRealizado')) {
                return ("diviframe|<iframe id=\"form\" src=\"/main/?action=formulario&sesion=&datos=" . $sAccion . separador . $iId . "\"  width=\"100%\"" .
    ...
    function subir_Fichero_Documento($aParametros)
    {
        if (is_array($aParametros)) {
            ...
            return "contenedor|<iframe id=\"formsubir\" src=\"/main/?action=documentossg:general:upload:nuevo&sesion=&datos=" .
    ...
    function procesa_Ver_Cuestionario($aParametros)
    {
        ...
        return ("contenedor|<iframe id=\"formmedio\" src=\"/main/?action=documentacion:formulariomedio:formulario:nuevo&sesion=&datos=" . $iIdLegislacion . "\"  width=\"100%\"" .
