...
class Procesar_Detalles
{
    ...
    function procesa_Detalles_Procesos($sAccion, $aParametros)
    {
        ...
        if ($aIterador = $oBaseDatos->coger_Fila()) {
            ...
            $sHtml = "diviframe|<iframe id=\"form\" src=\"/main/?action=inicio:nuevo:formulario:general&sesion=&datos=catalogo:contenidoproceso:formulario:editar:fila" . separador . $iIdProceso . "\"  width=\"100%\"" .
