...
CREATE TABLE IF NOT EXISTS botones_idiomas (
  id        SERIAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS contenido_adjunto (
  id           SERIAL NOT NULL,
  size         BIGINT,
  archivo_oid  OID,
...
CREATE TABLE IF NOT EXISTS division_ayuda (
  id     SERIAL NOT NULL,
  idioma INTEGER,
  texto  TEXT,
  boton  INTEGER,
...
CREATE TABLE IF NOT EXISTS ficha_personal_cambio_departamento (
  id                        SERIAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS ficha_personal_cambio_perfil (
  id                  SERIAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS ficha_personal_datos_personales (
  nombre               CHARACTER VARYING(32),
...
CREATE TABLE IF NOT EXISTS ficha_personal_experiencia_laboral (
  id           SERIAL NOT NULL,
  ficha        INTEGER,
...
CREATE TABLE IF NOT EXISTS ficha_personal_formacion_academica (
...
CREATE TABLE IF NOT EXISTS ficha_personal_formacion_tecnica (
  id      SERIAL NOT NULL,
  ficha   INTEGER,
  lugar   CHARACTER VARYING(64),
  desde   DATE,
...
CREATE TABLE IF NOT EXISTS ficha_personal_idiomas (
...
CREATE TABLE IF NOT EXISTS ficha_personal_incorporacion (
  empresa             CHARACTER VARYING(64),
...
CREATE TABLE IF NOT EXISTS ficha_personal_otros_cursos (
  id      SERIAL NOT NULL,
  ficha   INTEGER,
  lugar   CHARACTER VARYING(64),
  inicio  DATE,
...
CREATE TABLE IF NOT EXISTS ficha_personal_preformacion (
...
CREATE TABLE IF NOT EXISTS flujogramas (
  tipo_fichero INTEGER,
  proceso      INTEGER,
  id           SERIAL NOT NULL,
  size         BIGINT,
...
CREATE TABLE IF NOT EXISTS formula_aspectos (
...
CREATE TABLE IF NOT EXISTS historico_cuestionarios (
  id                    SERIAL NOT NULL,
  fecha                 DATE,
  usuario               INTEGER,
...
CREATE TABLE IF NOT EXISTS legislacion_aplicable (
  id          SERIAL NOT NULL,
  id_ley      INTEGER,
  id_ficha    INTEGER,
  nombre      CHARACTER VARYING(512),
...
CREATE TABLE IF NOT EXISTS preguntas_legislacion_aplicable (
  id                    SERIAL NOT NULL,
  legislacion_aplicable INTEGER,
  pregunta              TEXT,
...
CREATE TABLE IF NOT EXISTS requisitos_puesto (
  id       SERIAL NOT NULL,
  nombre   CHARACTER VARYING(32),
  fecha    DATE,
  codigo   CHARACTER VARYING(16),
...
CREATE TABLE IF NOT EXISTS requisitos_puesto_competencias (
  conocimientos TEXT,
  funciones     TEXT,
  id            INTEGER NOT NULL
);
...
CREATE TABLE IF NOT EXISTS requisitos_puesto_datos_puesto (
...
CREATE TABLE IF NOT EXISTS requisitos_puesto_formacion (
...
CREATE TABLE IF NOT EXISTS requisitos_puesto_ft (
  id                SERIAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS requisitos_puesto_promocion (
  liderazgo   BOOLEAN,
  mando       BOOLEAN,
  motivacion  BOOLEAN,
  negociacion BOOLEAN,
...
CREATE TABLE IF NOT EXISTS tipo_acciones (
  id     SERIAL NOT NULL,
  nombre CHARACTER VARYING(32),
  activo BOOLEAN,
  idioma INTEGER
...
CREATE TABLE IF NOT EXISTS tipo_acciones_idiomas (
  id        SERIAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS tipo_ambito_aplicacion (
  id     SERIAL NOT NULL,
  nombre CHARACTER VARYING(64),
  idioma INTEGER
);
...
CREATE TABLE IF NOT EXISTS tipo_ambito_aplicacion_idiomas (
  id        SERIAL NOT NULL,
  valor     CHARACTER VARYING(100),
  tipoamb   INTEGER,
  idioma_id INTEGER
...
CREATE TABLE IF NOT EXISTS tipo_area_aplicacion (
  id     SERIAL NOT NULL,
  nombre CHARACTER VARYING(64),
  idioma INTEGER
);
...
CREATE TABLE IF NOT EXISTS tipo_botones (
  id     SERIAL NOT NULL,
  nombre CHARACTER VARYING(64)
);
...
CREATE TABLE IF NOT EXISTS tipo_documento_idiomas (
  id        SERIAL NOT NULL,
  valor     CHARACTER VARYING(100),
  tipodoc   INTEGER,
  idioma_id INTEGER
...
CREATE TABLE IF NOT EXISTS tipo_estado_auditoria (
  id     SERIAL NOT NULL,
  nombre CHARACTER VARYING(32)
);
...
CREATE TABLE IF NOT EXISTS tipo_estados_curso (
  id     SERIAL NOT NULL,
  nombre CHARACTER VARYING(64)
);
...
CREATE TABLE IF NOT EXISTS tipo_frecuencia (
  id     SERIAL NOT NULL,
  nombre CHARACTER VARYING(64),
  valor  INTEGER
);
...
CREATE TABLE IF NOT EXISTS tipo_frecuencia_idiomas (
  id         SERIAL NOT NULL,
  valor      CHARACTER VARYING(100),
  frecuencia INTEGER,
  idioma_id  INTEGER
...
CREATE TABLE IF NOT EXISTS tipo_frecuencia_seg (
  id         SERIAL NOT NULL,
  nombre     CHARACTER VARYING(32),
  incremento INTERVAL
);
...
CREATE TABLE IF NOT EXISTS tipo_grado_promocion (
  id     SERIAL NOT NULL,
  nombre CHARACTER VARYING(32)
);
...
CREATE TABLE IF NOT EXISTS tipo_gravedad_idiomas (
  id        SERIAL NOT NULL,
  valor     CHARACTER VARYING(100),
  gravedad  INTEGER,
  idioma_id INTEGER
...
CREATE TABLE IF NOT EXISTS tipo_impactos_idiomas (
  id        SERIAL NOT NULL,
  valor     CHARACTER VARYING(100),
  impactos  INTEGER,
  idioma_id INTEGER
...
CREATE TABLE IF NOT EXISTS tipo_magnitud (
  id     SERIAL NOT NULL,
  nombre CHARACTER VARYING(64),
  valor  INTEGER
);
...
CREATE TABLE IF NOT EXISTS tipo_magnitud_idiomas (
  id        SERIAL NOT NULL,
  valor     CHARACTER VARYING(100),
  magnitud  INTEGER,
  idioma_id INTEGER
...
CREATE TABLE IF NOT EXISTS tipo_probabilidad (
  id     SERIAL NOT NULL,
  valor  INTEGER,
  nombre CHARACTER VARYING(64)
);
...
CREATE TABLE IF NOT EXISTS tipo_probabilidad_idiomas (
  id           SERIAL NOT NULL,
  valor        CHARACTER VARYING(100),
...
CREATE TABLE IF NOT EXISTS tipo_severidad (
  id     SERIAL NOT NULL,
  valor  INTEGER,
  nombre CHARACTER VARYING(64)
);
...
CREATE TABLE IF NOT EXISTS tipo_severidad_idiomas (
  id        SERIAL NOT NULL,
  valor     CHARACTER VARYING(100),
  severidad INTEGER,
  idioma_id INTEGER
