...
**Last Updated:** 2026-06 (Stage 8.9 in progress on `feat/stage-8.9-extract-catalog-base`). Extracted shared CatalogListado + CatalogFormulario bases + refactored the pure catalog modules (Perfiles/Sedes/Clientes/Criterios + all Tipo* ) to address repetition noted after 8.8. Plan committed first. 8.8 marked complete.
