...
FCKeditor.prototype.Create = function () {
    ...
    if (!this.CheckBrowser || this._IsCompatibleBrowser()) {
        document.getElementById('contenedor').innerHTML = '<input type="hidden" id="' + this.InstanceName + '" name="' + this.InstanceName + '" value="' + this._HTMLEncode(this.Value) + '" />';
        document.getElementById('contenedor').innerHTML = this._GetConfigHtml();
        document.getElementById('contenedor').innerHTML = this._GetIFrameHtml();
    }
    else {
