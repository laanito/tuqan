...
function initSlideLeftPanel(expandOnly) {
    ...
    if (!slideLeftPanelObj) {
        if (document.getElementById('divayuda')) {    // Object exists in HTML code?
            slideLeftPanelObj = document.getElementById('divayuda');
...
function keyboardShowLeftPanel() {
    //initSlideLeftPanel();
    sndReq('ayuda:ayuda:ayuda:ayuda', '', 1);
    return false;
