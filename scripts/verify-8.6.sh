...
echo "=== Stage 8.6 / 8.7 / 8.8 / 9.1 / 9.2 / 9.3 / 9.4 / 9.5 / 9.6 / 9.7 / 9.8 / 9.9 / 9.10 / 9.11 / 9.12 / 9.13 / 9.14 / 9.15 / 9.16 / 9.17 / 9.18 / 9.19 / 9.20 / 9.21 / 9.22 / 9.23 / 9.24 / 9.25 / 9.26 / 9.27 Verification (non-interactive) ==="
echo ""
...
-- 9.27 Mejora state machine evidence
...
-- 9.26 Documentación content evidence
SELECT COUNT(*) AS contenido_texto_rows FROM contenido_texto;
...
echo ""
echo "=== 8.6/8.7/8.8/9.1/9.2/9.3/9.4/9.5/9.6/9.7/9.8/9.9/9.10/9.11/9.12/9.13/9.14/9.15/9.16/9.17/9.18/9.19/9.20/9.21/9.22/9.23/9.24/9.25/9.26/9.27 non-interactive verification finished ==="
