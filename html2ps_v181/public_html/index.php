<?php
// $Header: /home/cvs/qnovaunidoCVS/html2ps_v181/public_html/index.php,v 1.1 2006-08-31 08:36:05 jmartinez Exp $
...
<p><a target="_blank" href="http://www.cs.wisc.edu/~ghost/" title="More about GhostView - [new window]">GhostView</a>
    can be used to read PostScript files, and <a target="_blank"
                                                 href="http://www.adobe.com/products/acrobat/readstep2.html"
                                                 title="Download Adobe Acrobat - [new window]">Adobe Acrobat Reader</a>
    can be used to read PDF files.</p>
<p>See also: <a target="_blank" href="help/index.html" title="Table of contents - [new window]">html2ps/pdf
        documentation</a></p>
...
<div style="width:500px;">
    <form action="html2ps.php" method="get" style="margin-top:12px">
        <fieldset>
            ...
            <div class="form-row">
                <label class="hand" for="ur"><span class="labl">Enter URL here: </span></label>
                <span class="formw">
...
<input class="nulinp" type="checkbox" name="scalepoints" value="1" checked="checked" id="scalepoint"/>
 ...
 <input class="nulinp" type="checkbox" name="renderlinks" value="1" checked="checked" id="renderl"/>
            ...
            <div class="form-row">
                ...
                <span class="formw">
<input class="nulinp" type="checkbox" name="renderforms" value="1" id="renderl"/><sup style="color: red">beta, FPDF output only!</sup>
</span>
            </div>
...
<option value="koi8-r">koi8-r</option>
        ...
        <fieldset>
            ...
            <div class="form-row">
                ...
                <span class="formw">
<input class="nulinp" type="radio" id="ps" name="method" value="fastps"/>PostScript&nbsp;&nbsp;<label
                            for="pdf">&nbsp;</label>
...
Note: not all output methods support all PDF compatibility levels! 
            ...
            <div class="form-row">
                ...
                <span class="formw">
<input class="nulinp" type="radio" id="towher" name="output" value="0" checked="checked"/>Browser (PDF will be opened in browser, Postsript will be downloaded)&nbsp;<label
                            for="towher1">&nbsp;&nbsp;&nbsp;</label>
...
<input class="nulinp" type="checkbox" id="compr" name="compress" value="1"/>Compress output file using GZIP<label
                            for="compr1">&nbsp;&nbsp;</label><br/>
</span>
            </div>

            <div class="form-row">
                <label class="hand" for="transparency_workaround"><span
                            class="labl">Hacks &amp; Workarounds</span></label>
                <span class="formw">
...
<p>html2ps is free and open-source for commercial and non-commercial use. <a target=_blank
                                                                             href="http://www.tufat.com/html2ps.php"
                                                                             title="More about html2ps">Read more about
        html2ps</a>.</p>

<p><a target=_blank
      href="https://www.paypal.com/xclick/business=g8z@yahoo.com&item_name=html2ps+donation&no_shipping=1&currency_code=USD">Donate
        to the html2ps project</a></p>
