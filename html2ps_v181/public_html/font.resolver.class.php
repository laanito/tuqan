<?php
// $Header: /home/cvs/qnovaunidoCVS/html2ps_v181/public_html/font.resolver.class.php,v 1.1 2006-08-31 08:36:05 jmartinez Exp $
...
class FontResolver
{
    ...
    function get_family_encoding_override($family, $weight, $style, $encoding)
    {
        ...
        if (!isset($this->overrides[$encoding][$family])) {
            return "";
        }
        if (!isset($this->overrides[$encoding][$family][$weight])) {
            return "";
        }
        if (!isset($this->overrides[$encoding][$family][$weight][$style])) {
            return "";
        }
    ...
    function add_alias($alias, $family)
    {
        $this->aliases[$alias] = $family;
    }
