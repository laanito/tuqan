<?php
// $Header: /home/cvs/qnovaunidoCVS/html2ps_v181/public_html/css.border.inc.php,v 1.1 2006-08-31 08:36:05 jmartinez Exp $
...
{
    if (preg_match("/\b(transparent|black|silver|gray|white|maroon|red|purple|fuchsia|green|lime|olive|yellow|navy|blue|teal|aqua|rgb(.*?))\b/i", $value)) {
    ...
    if (preg_match("/#([[:xdigit:]]{3}|[[:xdigit:]]{6})\b/i", $value)) {
        return BORDER_VALUE_COLOR;
    };
...
function css_border($value, $root)
{
    return css_border_x($value, $root, "css_border_color", "css_border_width", "css_border_style");
}

;
function css_border_top($value, $root)
{
    return css_border_x($value, $root, "css_border_top_color", "css_border_top_width", "css_border_top_style");
}

;
function css_border_right($value, $root)
{
    return css_border_x($value, $root, "css_border_right_color", "css_border_right_width", "css_border_right_style");
}

;
function css_border_bottom($value, $root)
{
    return css_border_x($value, $root, "css_border_bottom_color", "css_border_bottom_width", "css_border_bottom_style");
}

;
function css_border_left($value, $root)
{
    return css_border_x($value, $root, "css_border_left_color", "css_border_left_width", "css_border_left_style");
}
...
function css_border_x_style($value, $root, $mode)
{
    ...
    switch ($value) {
        case "solid":
            $border[$mode]['style'] = BS_SOLID;
            break;
        case "dashed":
            $border[$mode]['style'] = BS_DASHED;
            break;
        case "dotted":
            $border[$mode]['style'] = BS_DOTTED;
            break;
        case "double":
            $border[$mode]['style'] = BS_DOUBLE;
            break;
        case "inset":
            $border[$mode]['style'] = BS_INSET;
            break;
        case "outset":
            $border[$mode]['style'] = BS_OUTSET;
            break;
        case "groove":
            $border[$mode]['style'] = BS_GROOVE;
            break;
        case "ridge":
            $border[$mode]['style'] = BS_RIDGE;
            break;
        default:
            $border[$mode]['style'] = BS_NONE;
            break;
    };
    pop_border();
    push_border($border);
...
function css_border_top_style($value, $root)
{
    css_border_x_style($value, $root, 'top');
}

function css_border_bottom_style($value, $root)
{
    css_border_x_style($value, $root, 'bottom');
}

function css_border_left_style($value, $root)
{
    css_border_x_style($value, $root, 'left');
}

function css_border_right_style($value, $root)
{
