...
class WCConstant
{
    ...
    function to_ps()
    {
        return $this->width . " wc-create-constant";
    }

    function copy()
    {
        return new WCConstant($this->width);
    }
...
class WCFraction
{
    ...
    function to_ps()
    {
        return $this->fraction . " wc-create-fraction";
    }

    function copy()
    {
        return new WCFraction($this->fraction);
    }
