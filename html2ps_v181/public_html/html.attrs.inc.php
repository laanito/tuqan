<?php
// $Header: /home/cvs/qnovaunidoCVS/html2ps_v181/public_html/html.attrs.inc.php,v 1.1 2006-08-31 08:36:05 jmartinez Exp $
...
function execute_attrs_before($root)
{
    execute_attrs($root, "_before");
}

function execute_attrs_after($root)
{
    execute_attrs($root, "_after");
}

function execute_attrs_after_styles($root)
{
    execute_attrs($root, "_after_styles");
}
