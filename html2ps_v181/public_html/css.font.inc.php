<?php
// $Header: /home/cvs/qnovaunidoCVS/html2ps_v181/public_html/css.font.inc.php,v 1.1 2006-08-31 08:36:05 jmartinez Exp $
...
function push_font_family($family)
{
    global $g_font_family;
    array_unshift($g_font_family, $family);
}

function pop_font_family()
{
    global $g_font_family;
    array_shift($g_font_family);
}

function push_font_style($weight)
{
    global $g_font_style;
    array_unshift($g_font_style, $weight);
}

function pop_font_style()
{
    global $g_font_style;
    array_shift($g_font_style);
}

function get_font_style()
{
    global $g_font_style;
    return $g_font_style[0];
}

function push_font_weight($weight)
{
    global $g_font_weight;
    array_unshift($g_font_weight, $weight);
}

function pop_font_weight()
{
    global $g_font_weight;
    array_shift($g_font_weight);
}

function get_font_weight()
{
    global $g_font_weight;
    return $g_font_weight[0];
}

function push_font_size($size)
{
    global $g_font_size;
    array_unshift($g_font_size, $size);
}

function pop_font_size()
{
    global $g_font_size;
    array_shift($g_font_size);
}

function get_font_size()
{
    global $g_font_size;
    return trim($g_font_size[0]);
}
