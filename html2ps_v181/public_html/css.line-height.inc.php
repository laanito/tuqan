<?php
// $Header: /home/cvs/qnovaunidoCVS/html2ps_v181/public_html/css.line-height.inc.php,v 1.1 2006-08-31 08:36:05 jmartinez Exp $
...
;
function default_line_height()
{
    return new LineHeight_Relative(1.1);
}
...
function get_line_height()
{
    ...
    return $g_line_height[0];
}

function push_line_height($align)
{
    global $g_line_height;
    array_unshift($g_line_height, $align);
}

function pop_line_height()
{
    global $g_line_height;
    array_shift($g_line_height);
}

function ps_line_height($value)
{
    return $value->to_ps();
}
