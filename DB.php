 ...
 * @version    CVS: $Id: DB.php,v 1.1 2006-08-31 08:36:04 jmartinez Exp $
...
class DB
{
    ...
    function &factory($type, $options = false)
    {
        ...
        if (!class_exists($classname)) {
            $pera=new \PEAR();
            $tmp = $pera->raiseError(null, DB_ERROR_NOT_FOUND, null, null,
 ...
 * @link       http://pear.php.net/package/DB
 */
class DB_Error extends \PEAR_Exception
{
    // {{{ constructor
    ...
    {
        parent::__construct("Error en DB:",DB_ERROR, DB_ERROR);
    }
